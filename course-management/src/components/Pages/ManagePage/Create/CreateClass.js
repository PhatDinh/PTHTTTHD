    ...
    return <Box sx={{
        ...
        <Box sx={{
            ...
            <Box sx={{
                ...
                <Typography variant='h6' align='start'>Class name</Typography>
                <TextField placeholder="Class name" onChange={addName} fullWidth></TextField>
            </Box>
            <Box sx={{
                width: '80vw',
                marginLeft: 'auto',
                ...
                <TextField placeholder="Description" onChange={addDesc} fullWidth multiline></TextField>
            </Box>
            <Box sx={{
                width: '80vw',
                marginLeft: 'auto',
                ...
                <Typography variant='h6' align='start'>Departments</Typography>
                {
                    <Table>
                        <TableBody>
                            {
